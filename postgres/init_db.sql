...
CREATE TABLE dwh.country (
    ...
    iso2_code       VARCHAR(2) NOT NULL,   -- 2-letter ISO code (e.g., "AF")
    country_name    VARCHAR(255) NOT NULL, -- official name in uppercase or standard
    display_name    VARCHAR(255) NOT NULL, -- human-friendly name (capitalized)
    iso3_code       VARCHAR(3),            -- 3-letter ISO code (e.g., "AFG")
    numeric_code    INT,                   -- ISO numeric code (e.g., 4)
    phone_code      INT NOT NULL           -- country calling code (e.g., 93)
);

INSERT INTO dwh.country (iso2_code, country_name, display_name, iso3_code, numeric_code, phone_code)
VALUES
